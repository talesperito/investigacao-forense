...
const ptUrl = 'https://www.investigacaoforense.com/aplicacoes/locus';
const enUrl = 'https://www.investigacaoforense.com/en/applications/locus';
const ogImage = 'https://www.investigacaoforense.com/images/locus/og-locus.png';

export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  const resolvedParams = await params;
  const locale = resolvedParams.locale;
  const t = await getTranslations({ locale, namespace: 'Locus' });
...
export default async function LocusLayout({
  children,
  params,
}: {
  children: ReactNode;
  ...
  const softwareApplicationSchema = {
    ...
    name: 'Locus — Dinâmica Pericial de Percurso',
  ...
  const pageMessages = {
    Locus: (allMessages as Record<string, unknown>).Locus,
  };
