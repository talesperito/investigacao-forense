...
export default function ContatoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simula envio (aqui você integraria com serviço de email)
    setTimeout(() => {
      setStatus('sucesso');
      setFormData({ nome: '', email: '', telefone: '', mensagem: '' });
      
      // Redireciona para mailto como fallback
      const subject = encodeURIComponent(`Contato de ${formData.nome}`);
      const body = encodeURIComponent(
        `Nome: ${formData.nome}\nEmail: ${formData.email}\nTelefone: ${formData.telefone}\n\nMensagem:\n${formData.mensagem}`
      );
      window.location.href = `mailto:talesperito@gmail.com,matheusvieira1204@gmail.com?subject=${subject}&body=${body}`;
    }, 1000);
  };
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-gray-900 to-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300">
            Vamos conversar sobre como podemos ajudar seu negócio a alcançar novos patamares através da tecnologia
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* WhatsApp */}
              <div className="bg-gray-800/50 rounded-xl p-8 border border-gray-700">
                <h3 className="text-2xl font-bold text-white mb-4">Contato Direto via WhatsApp</h3>
                <p className="text-gray-300 mb-6">
                  Prefere conversar diretamente? Envie uma mensagem pelo WhatsApp e responderemos o mais rápido possível.
                </p>
              ...
              {/* E-mails */}
              <div className="bg-gray-800/50 rounded-xl p-8 border border-gray-700">
                <h3 className="text-2xl font-bold text-white mb-4">E-mails</h3>
              ...
              <div className="bg-gray-800/50 rounded-xl p-8 border border-gray-700">
                ...
                <p className="text-gray-300">
                  ...
                  Sábado: 9h às 13h<br/>
                  <span className="text-gray-400">Respondemos em até 24 horas úteis</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8">
            Explore nosso portfólio e veja como podemos ajudar seu negócio
          </p>
