  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <section className="py-16 px-4 bg-gray-900/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Conheça Nossas Soluções</h2>
          <p className="text-gray-300 mb-8">Explore nosso portfólio e veja como podemos ajudar seu negócio</p>
