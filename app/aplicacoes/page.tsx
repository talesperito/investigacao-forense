    ...
    <section className="py-16 px-4 md:px-8 max-w-5xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-400 mb-8">
          Nesta página apresentamos protótipos funcionais (MVPs - <span className="font-semibold">Minimum Viable Product</span>), desenvolvidos para avaliação técnica,
      ...
      <div className="space-y-10">
        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-xl p-8 hover:border-blue-600 transition-all duration-300">
          <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
            <h2 className="text-3xl font-bold flex items-center">
              <svg className="w-8 h-8 mr-3 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-xl p-8 hover:border-blue-600 transition-all duration-300">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-blue-800 border-t">
            <div className="text-sm text-gray-400">
