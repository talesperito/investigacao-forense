    ...
    <section className="py-16 px-4 md:px-8 max-w-5xl mx-auto">
      ...
      <div className="space-y-10">
        <div className="bg-blue-900/20 border border-blue-800 rounded-xl p-8">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-blue-800 flex-wrap gap-4">
            <div className="text-sm text-gray-400">
              <span className="font-semibold text-gray-300">Stack:</span> Next.js, Supabase PostgreSQL, SHA-256
            </div>
            <button disabled className="bg-gray-700 text-gray-400 font-semibold py-2 px-6 rounded-lg cursor-not-allowed flex items-center" title="A aplicação ainda não está disponível publicamente">
